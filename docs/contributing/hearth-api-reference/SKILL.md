---
name: hearth-api-reference
description: >
  Quick-reference table of commonly used Hearth API signatures: Expr, Type, MIO,
  ValDefsCache, CaseClass, Enum, LambdaBuilder, Environment. Always verify with MCP.
...
- [`../hearth-documentation/`](../hearth-documentation/SKILL.md) — finding Hearth docs, verifying APIs via MCP, Hearth source as reference
- [`../hearth-def-caching/`](../hearth-def-caching/SKILL.md) — ValDefsCache detailed usage patterns
- [`../hearth-lambda-builder/`](../hearth-lambda-builder/SKILL.md) — when to use LambdaBuilder vs alternatives
- [`../hearth-standard-extensions/`](../hearth-standard-extensions/SKILL.md) — loading type extractors (IsCollection, IsMap, etc.)

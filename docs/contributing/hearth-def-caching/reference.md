# Def-caching reference: detailed examples and API

This file contains the full details of the def-caching pattern. For the overview, recipe,
and Hash worked example, see [`SKILL.md`](SKILL.md).

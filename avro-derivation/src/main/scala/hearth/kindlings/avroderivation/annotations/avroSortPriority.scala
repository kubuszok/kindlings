...
/** Controls the ordering of subtypes within an Avro ENUM or UNION schema.
  * Lower priority values appear first. Subtypes without this annotation default to priority 0.
  *

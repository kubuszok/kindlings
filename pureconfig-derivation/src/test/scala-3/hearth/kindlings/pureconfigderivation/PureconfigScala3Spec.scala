  ...
  group("named tuples (Scala 3.7+)") {
    ...
    group("reading") {
      ...
      test("named tuple with snake_case member names") {
        ...
        val r = KindlingsConfigReader.derived[(firstName: String, lastName: String)]
    ...
    group("writing") {
      ...
      test("simple named tuple") {
        val w = KindlingsConfigWriter.derived[(name: String, age: Int)]
      ...
      test("named tuple with nested case class") {
        val w = KindlingsConfigWriter.derived[(person: SimplePerson, score: Int)]
      ...
      test("single-element named tuple") {
        val w = KindlingsConfigWriter.derived[(field: Int)]
      ...
      test("named tuple with snake_case member names") {
        implicit val cfg: PureConfig = PureConfig().withSnakeCaseMemberNames
        val w = KindlingsConfigWriter.derived[(firstName: String, lastName: String)]
